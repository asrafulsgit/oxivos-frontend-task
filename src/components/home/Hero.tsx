...
const Hero = () => {
  return (
    <section
      className="relative mx-auto grid min-h-110 sm:min-h-120   md:min-h-150 
    ...
    >
      ...
      >
        <motion.span
          variants={item}
          className=" text-center sm:text-left text-[10px] 
        ...
        <motion.h1
          variants={item}
          className="max-w-xl text-balance  font-display text-4xl 
          leading-[0.9] tracking-tighter text-primary-light mb-4 md:mb-8
          sm:text-left sm:text-5xl md:text-7xl lg:text-8xl"
        >
          A Legacy in
          <br />
        ...
        <motion.p
          variants={item}
          className="mb-4 max-w-md text-base leading-relaxed text-primary-light/60 
          md:mb-10 sm:text-sm md:text-lg "
        >
        ...
        <motion.div variants={item} className="self-start">
          <Link href="/products" className="group w-fit">
            ...
            <div
              className="mt-1 h-px w-full origin-left bg-primary transition-transform 
            duration-500 group-hover:scale-x-110"
            />
          </Link>
        </motion.div>
      </motion.div>
